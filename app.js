            ...
            try {
                ...
                const xpTodayVal = allActs.reduce((s, a) =>
                    s + (a.completionHistory || [])
                        .filter(e => !e.isPenalty && e.date && e.date.slice(0, 10) === todayStr)
        ...
        window.takeAgainChallenge = function(index) {
            ...
            const nextMonth = new Date();
            nextMonth.setMonth(nextMonth.getMonth() + 1);
            challenge.endDate = nextMonth.toISOString().split('T')[0];
        ...
        window.openCreateGroupModal = function() {
            ...
            document.getElementById('groupEndDate').value   = end.toISOString().split('T')[0];
